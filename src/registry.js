...
export const examples = [
  ...
  {
    id: "redux-toolkit",
    title: "Redux Toolkit (real library)",
    useCase: "Same cart, rebuilt with @reduxjs/toolkit + react-redux",
    summary:
      "The same useReducer+Context cart from example 9, rebuilt with the actual Redux Toolkit library.",
    Demo: lazy(() => import("./examples/11-redux-toolkit/Demo.jsx")),
  },
];
